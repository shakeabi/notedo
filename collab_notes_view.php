<?php
  ...
  if(isset($_GET['collab_u_id']) && isset($_GET['collab_n_id'])){
      $collab_u_id = $_GET['collab_u_id'];
      $collab_n_id = $_GET['collab_n_id'];
  }


    $table = $collab_u_id.'notes';

    $query = "SELECT * FROM $table WHERE id = $collab_n_id";
...
<?php include_once('includes/header.php'); ?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <!-- Sidebar -->
<?php include_once('includes/sidebar_edit_c.php') ?>
